...
A detailed project description is available in the project [document](doc/3dy4-project-2026.pdf). The unique constraints for each group, including different modes of operation (i.e., custom sample rates), are available [here](doc/3dy4-constraints-group-70.pdf).
...
All project source code must be submitted before 7 p.m. on Thursday, March 26. The project cross-examinations and oral presentations will take place during the week of March 30, and the detailed final project report is due before 7 p.m. on Thursday, April 2.
